...
This folder contains sample documents, demo scripts, and example outputs to help you understand how NexTax works.
...
2. Run NexTax pipeline to produce redacted outputs
...
pipeline = NexTaxPipeline(vault_password="demo")
