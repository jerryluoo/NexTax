...
This is the core privacy guarantee of NexTax.
"""
...
class TestPIILeakPreventionMockedClaude:
    ...
    @patch("nextax.ai.claude_client.Anthropic")
...
class TestSafetyCheck:
    ...
    def test_safety_check_blocks_leaked_ssn(self):
        from nextax.ai.claude_client import ClaudeClient, PIILeakError
    ...
    def test_safety_check_allows_clean_text(self):
        from nextax.ai.claude_client import ClaudeClient
