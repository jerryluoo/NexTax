...
class TestEdgeCaseSSNFormats:
    ...
    def test_ssn_near_dollar_amounts(self):
        ...
        from nextax.detection import PIIDetector
        from nextax.redaction import Tokenizer
...
class TestEdgeCaseRehydration:
    ...
    def test_rehydrate_with_unknown_tokens(self):
        ...
        from nextax.redaction import Rehydrator
...
class TestEdgeCaseImageFiles:
    ...
    def test_is_image_file_detection(self):
        from nextax.extraction.image_extractor import is_image_file
    ...
    def test_nonexistent_image_raises(self):
        from nextax.extraction.image_extractor import extract_text_from_image
        with pytest.raises(FileNotFoundError):
