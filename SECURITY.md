...
If you discover a security vulnerability in NexTax, please report it responsibly:

1. **DO NOT** open a public GitHub issue for security vulnerabilities
2. Email the maintainers directly or use [GitHub's private vulnerability reporting](https://github.com/jerryluoo/NexTax/security/advisories/new)
3. Include:
...
NexTax's security is built on these principles:
...
NexTax relies on these security-critical dependencies:
