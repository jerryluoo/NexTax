...
published: false
description: "NexTax redacts PII from tax documents before sending to Claude — here's the architecture and Data Sensitivity Level framework behind it"
...
I built [NexTax](https://github.com/jerryluoo/NexTax), an open-source Python tool that acts as a privacy layer between tax documents and AI.
...
*NexTax is a privacy tool, not tax advice software. Always consult a CPA before filing.*
