...
## Title
NexTax — Using Presidio for privacy-preserving AI tax assistance

## Body
Hi Presidio team and community!

I wanted to share a project that uses Microsoft Presidio as its core PII detection engine: **[NexTax](https://github.com/jerryluoo/NexTax)**.

### What it does
NexTax is a privacy layer for safely using AI (Claude) with tax documents. It extracts text from W-2s, 1099s, and other tax forms, uses Presidio to detect all PII, replaces identity data with tokens, and sends only the sanitized text to the AI.
...
MIT license: https://github.com/jerryluoo/NexTax
