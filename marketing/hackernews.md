...
## Title
Show HN: NexTax – Safely use AI for tax filing by redacting PII locally before sending to Claude

## URL
https://github.com/jerryluoo/NexTax

## Text (for text post variant)
I built NexTax because I wanted to use AI to help with my taxes but was uncomfortable uploading my W-2 (with SSN, address, bank info) to a cloud API.

NexTax sits between your tax documents and AI. It:
