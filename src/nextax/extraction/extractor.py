...
from nextax.extraction.pdf_extractor import extract_text_digital
from nextax.extraction.ocr_extractor import extract_text_ocr_from_pdf, is_tesseract_available
