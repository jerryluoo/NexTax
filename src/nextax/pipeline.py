"""Pipeline — orchestrates the full NexTax workflow.
...
from nextax.ai.claude_client import ClaudeClient, PIILeakError, TaskType
from nextax.detection.detector import PIIDetector, PIIEntity
from nextax.extraction import extract_text_from_file
from nextax.redaction.rehydrator import Rehydrator
from nextax.redaction.tokenizer import Tokenizer
...
class NexTaxPipeline:
    ...
    def __init__(
        ...
        Args:
            ...
            vault_dir: Directory for vault files. Defaults to ~/.nextax/
        ...
        logger.info("NexTax pipeline initialized (persist_vault=%s)", persist_vault)
