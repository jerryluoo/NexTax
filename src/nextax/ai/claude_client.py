...
class ClaudeClient:
    ...
    def _safety_check(text: str) -> None:
        ...
        from nextax.detection.detector import PIIDetector

        # Strip NexTax tokens before re-detection — they contain words like
        ...
        if leaked:
            ...
            error_msg = (
                ...
                f"https://github.com/jerryluoo/NexTax/issues"
            )
